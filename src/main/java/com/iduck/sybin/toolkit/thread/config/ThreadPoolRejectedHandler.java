package com.iduck.sybin.toolkit.thread.config;
...
public class ThreadPoolRejectedHandler {
    private static final Logger log = LoggerFactory.getLogger(ThreadPoolRejectedHandler.class);
    ...
    private static void recordLog(ThreadPoolExecutor executor) {
        log.warn("ThreadPoolRejectedHandler => The current thread pool exploded. Run thread count:{}; Active thread count:{}; Blocking queue count:{}.",
